...
export default function popupDesc({ onclose, openModalDes, onConfirm }) {
    return (
        <div
            onClick={onclose}
                ...
                <div className=" flex flex-col gap-3  px-10 py-7 ">
                    <div className=" text-black font-bold  text-2xl">
                        <div className="flex ">
                            ...
                            <h1 className="text-xl  font-bold mt-6  ">Decision de signalement architecte</h1>
                    ...
                    <div className=" flex flex-col gap-4">
                        ...
                        <Checkbox label={<span className="text-lg font-semibold text-gray-900 pl-3"> Suspendre temporairement</span>} containerProps={{
                            className: "p-0 flex flex-row items-center ",
                        }} color="black" />


                        <Checkbox label={<span className="text-lg font-semibold text-gray-900 pl-3"> Suspendre définitivement </span>} containerProps={{
                            className: "p-0 flex flex-row items-center ",
                        }} color="black" />
